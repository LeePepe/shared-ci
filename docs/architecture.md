...
- [Schemas](../schemas/) describe context, finding, policy and quality v1 shapes.
  Semantic validation stays in the corresponding implementation; no registry
  schema or distribution resolver exists in this tree.
